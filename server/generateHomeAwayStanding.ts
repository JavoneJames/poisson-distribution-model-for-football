...
import { Fixture, HomeAwayStanding, LeagueData, Outcome } from "./types/datatypes.d.ts";
...
const storeHomeStanding: Map<string, HomeAwayStanding> = new Map();
const storeAwayStanding: Map<string, HomeAwayStanding> = new Map();
...
async function writeStandingsToFile(league: string | null): Promise<void> {
 ...
 */
function updateTeamStanding(standings: Map<string, HomeAwayStanding>, team: string, teamScore: number, opponentScore: number): void {
 ...
 */
function createNewStanding(teamScore: number, opponentScore: number, outcome: Outcome): HomeAwayStanding {
  return {
    GP: 1, // Games Played
 ...
 * @param outcome - The outcome of the match as an Outcome type ('win', 'loss', or 'draw').
 */
function updateExistingStanding(team: HomeAwayStanding, teamScore: number, opponentScore: number, outcome: Outcome): void {
