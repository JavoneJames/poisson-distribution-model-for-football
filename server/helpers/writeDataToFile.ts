import { HomeAwayAnalysis } from "./../types/datatypes.d.ts";
 ...
 */
export async function writeParsedData(league: string | null | undefined, filename: string, data: Map<string, HomeAwayStanding> | Map<string, HomeAwayAnalysis>): Promise<void> {
 ...
 */
async function writeDataToFile(filepath: string, data: Map<string, HomeAwayStanding> | LeagueData | Map<string, HomeAwayAnalysis>): Promise<void> {
  try {
 ...
 */
function serializeData(data: Map<string, HomeAwayStanding> | LeagueData | Map<string, HomeAwayAnalysis>) {
 ...
 * @returns The generated file path as a string.
 */
function getLocalFilePath(league: string | null | undefined, filename: string): string {
